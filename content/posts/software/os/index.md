...
If you're like me, you'll take the second choice. Since you're probably not, let's talk about option 1 first. Also, phones are a bit different from desktops, so let's
...
Linux is actually not one operating system but rather a kernel, that is a core around which many actual operating systems are built. These OSes which are based
...
unfortunate because it raises the hurdle for people interested in trying Linux out but don't worry: it's not as bad as it seems.  

#### Just try it

You are immediately faced with the question of what distro to actually use.
...
any distro on an USB stick, plug it into your machine, boot from it and **boom** 
...
do it because you own the device, not the other way round.
...
just take the code and do their own thing with it. Another distro is born.  
